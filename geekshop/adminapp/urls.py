...
urlpatterns = [
    ...
    path('products/create/category/<int:pk>/', adminapp.ProductCategoryCreateView.as_view(), name='product_create'),
    ...
    path('products/update/<int:pk>/', adminapp.ProductCategoryUpdateView.as_view(), name='product_update'),
